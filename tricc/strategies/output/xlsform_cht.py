...
class XLSFormCHTStrategy(XLSFormCDSSStrategy):
    ...
    def get_cht_input(self):
        ...
        df_input.loc[len(df_input)] = [
            "begin group",
            "inputs",
            *list(langs.get_trads("Inputs", force_dict=True).values()),
        ...
        df_input.loc[len(df_input)] = [
            "hidden",
            "task_id",
            *list(langs.get_trads("Task ID", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            "",
            "",
        ...
        df_input.loc[len(df_input)] = [
            "db:person",
            "_id",
            *list(langs.get_trads("Patient ID", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            "",
            "db-object",
        ...
        df_input.loc[len(df_input)] = [
            "string",
            "patient_id",
            *list(langs.get_trads("Medic ID", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            "",
            "hidden",
        ...
        df_input.loc[len(df_input)] = [
            "string",
            "patient_name",
            *list(langs.get_trads("Patient Name", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            "",
            "hidden",
        ...
        df_input.loc[len(df_input)] = [
            "string",
            "sex",
            *list(langs.get_trads("Patient Sex", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            "",
            "hidden",
        ...
        df_input.loc[len(df_input)] = [
            "calculate",
            "_id",
            *list(langs.get_trads("label", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            *list(langs.get_trads("", force_dict=True).values()),
            "",
            "",
